...
auth_channel = environ.get('AUTH_CHANNEL', 'Star_Bots_Tamil')
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '1391556668 5162208212').split()]
...
DEF_WATER_MARK_FILE = ""
LOGGER = logging
lazydownloaders = [int(lazydownloaders) if id_pattern.search(lazydownloaders) else lazydownloaders for lazydownloaders in environ.get('PRIME_DOWNLOADERS', '1391556668 5162208212').split()]
